def stampamod4provv(finestra, marche, uscita, macello, allevamento, trasportatore, mod4, datauscita)
			#mod4provv(mdatimacellazione, arrmarche, combousc.active, combomacdest.active, combotrasp.active, mod4usc.text + "/" + Time.parse("#{datamod4uscingl}").strftime("%y"))
...
#	errore = 0
#	if uscita[0] == 9
#		if macello[4].to_s == "" or macello[5].to_s == "" or macello[6].to_s == ""
#			Errore.avviso(finestra, "Manca l'indirizzo del macello, inseriscilo.")
#			modmacelli(macello[0])
#			errore = 1
#		end
#	else
#		if allevamento[4].to_s == "" or allevamento[5].to_s == "" or allevamento[6].to_s == ""
#			Errore.avviso(finestra, "Manca l'indirizzo dell'allevamento, inseriscilo.")
#			modallevamenti(allevamento[0])
#			errore = 1
#		end
#	end
...
#foglio.restore_state
	#puts @stallaoper.stalle.region_id
...
#	foglio.add_text(z, qvar, testomac13, dimcar)
	...
	if uscita[0] == 3
		...
		coddest = allevamento[3]
		dendest = allevamento[1]
		indirizzodest = "#{allevamento[4]} - #{allevamento[5]} - #{allevamento[6]}"
	elsif uscita[0] == 9
		testodest2 = "[  ] Allevamento, [X] Macello, [  ] Mercato o fiera, [  ] Stalla di sosta, [  ] Pascolo, [  ] Altro ............................................................................................."
		coddest = macello[2]
		dendest = macello[1]
		indirizzodest = "#{macello[4]} - #{macello[5]} - #{macello[6]}"
	elsif uscita[0] == 28
		testodest2 = "[  ] Allevamento, [  ] Macello, [X] Mercato o fiera, [  ] Stalla di sosta, [  ] Pascolo, [  ] Altro ............................................................................................."
		coddest = allevamento[3]
		dendest = allevamento[1]
		indirizzodest = "#{allevamento[4]} - #{allevamento[5]} - #{allevamento[6]}" #(i mercati finiscono sotto gli allevamenti)"
	elsif uscita[0] == 30
	...
	foglio.start_new_page
	foglio.margins_pt(36) #, 36, 12, 13)
	...
	foglio.open_object do |testa|
		...
		testo2 = "<b>Allegato del Modello 4 #{mod4} - Capi totali: #{totcapi}</b>"
...
#	end
	...
	foglio.save_as("#{@dir}/altro/mod4provv.pdf")
	if @sistema == "linux"
		system("evince #{@dir}/altro/mod4provv.pdf")
	else
#		foglio.save_as('.\altro\allegato.pdf')
		@shell.ShellExecute('.\altro\mod4provv.pdf', '', '', 'open', 3)
	end
#end
end
