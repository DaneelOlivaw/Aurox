...
#	begin
	...
	contaprov = -1
	while combonazprov.active_iter[2] != "IT"
		contaprov+=1
...
#			else
		...
		if errore == 0
			...
			depositoingr["tiponazprov"] = combonazprov.active_iter[3]
			depositoingr["mod4"] = ""
			depositoingr["datamod4"] = ""
			depositoingr["tipomovimento"] = tipomovimento
			depositoingr["certsan"] = ""
			depositoingr["rifloc"] = ""
...
#			@primocapo = 1
	...
	boxingnas1.pack_start(bottanimale, false, false, 0)
