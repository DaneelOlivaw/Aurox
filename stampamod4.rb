def stampamod4(m4, anno, finestra)
	...
	if selcapi.cm_usc == 9
		...
		if selcapi.allevamenti.via.to_s == "" or selcapi.allevamenti.comune.to_s == "" or selcapi.allevamenti.provincia.to_s == ""
			...
			modallevamenti(selcapi.allevamenti_id)
			errore = 1
		end
	end
...
#		end
	...
	testodichiara2 = "Dichiara altres\xec che gli animali sopraccitati sono stati introdotti con regolare documentazione di accompagnamento"
	#q8 = q7 -dimcar*1.1
	qvar = qvar -dimcar*1.1
	#m5 = x - boh2
	foglio.add_text(z, qvar, testodichiara2, dimcar)
	testodichiara3 = "e provengono da aziende identificate dai seguenti codici aziendali ............................................................................................."
	#q9 = q8 -dimcar*1.1
	qvar = qvar -dimcar*1.1
	#m5 = x - boh2
	#puts foglio.pointer
	foglio.add_text(z, qvar, testodichiara3, dimcar)
	foglio.rectangle(z-5, qident+(dimcar/2), w, -127).stroke
	foglio.save_state
	foglio.fill_color Color::RGB::White
	foglio.stroke_color Color::RGB::White
	foglio.rectangle(z, qident, 104, 10).fill
	foglio.restore_state
	foglio.add_text(z, qident, testoident, dimcar)
	...
	testomac4 = "    a) [  ] NON SONO STATI           [  ] SONO STATI sottoposti a trattamento con le seguenti sostanze di cui agli art. 4 e 5"
	#q13 = q12 -dimcar*1.1
	qvar = qvar -dimcar*1.1
	foglio.add_text(z, qvar, testomac4, dimcar)
	testomac5 = "      del D.l.vo 16.03.2006, n. 158 e successive modifiche e integrazioni"
	#q14 = q13 -dimcar*1.1
	qvar = qvar -dimcar*1.1
	...
	qvar = qvar -dimcar*1.1
	foglio.add_text(z, qvar, testomac6, dimcar)
	testomac11 = "  3) [  ] Sono stati osservati i previsti tempi di sospensione per i trattamenti con i prodotti di cui al punto 2, nonch\xe9 quelli"
	#q20 = q19 -dimcar*1.1
	qvar = qvar -dimcar*1.1
	foglio.add_text(z, qvar, testomac11, dimcar)
	testomac12 = "    previsti in seguito alla somministrazione di alimenti contenenti premiscele con additivi del gruppo antibiotici,"
	#q21 = q20 -dimcar*1.1
	qvar = qvar -dimcar*1.1
	...
	testomac14 = "  4) [  ] Dichiara inoltre di allegare copia dell'elenco del trattamento recante firma del veterinario o dei veterinari prescrittori"
	#q23 = q22 -dimcar*1.1
	qvar = qvar -dimcar*1.1
	foglio.add_text(z, qvar, testomac14, dimcar)
	testomac15 = "    come previsto dal D.l.vo 16.03.2006, n. 158 e dal D.M. 28/05/1992."
	#q24 = q23 -dimcar*1.1
	qvar = qvar -dimcar*1.1
	foglio.add_text(z, qvar, testomac15, dimcar)
	testomac16 = "    Dichiara inoltre che gli animali sopraccitati non saranno sottoposti a trattamenti di cui ai punti 1, 2 e 3, nonch\xe9 alla"
	#q25 = q24 -dimcar*1.1
	qvar = qvar -dimcar*1.1
	foglio.add_text(z, qvar, testomac16, dimcar)
	testomac17 = "    somministrazione di alimenti contenenti premiscele con additivi del gruppo antibiotici, coccidiostatici o altre sostanze"
	#q26 = q25 -dimcar*1.1
	qvar = qvar -dimcar*1.1
	foglio.add_text(z, qvar, testomac17, dimcar)
	testomac18 = "    medicamentose."
	#q27 = q26 -dimcar*1.1
	qvar = qvar -dimcar*1.1
	foglio.add_text(z, qvar, testomac18, dimcar)

	foglio.rectangle(z-5, qmac+(dimcar/2), w, -207).stroke
	foglio.save_state
	foglio.fill_color Color::RGB::White
	foglio.stroke_color Color::RGB::White
	foglio.rectangle(z, qmac, 184, 10).fill
	foglio.restore_state
	foglio.add_text(z, qmac, testomac, dimcar)
	
	testodest = "<b>C) DESTINAZIONE</b>"
	qdest = qvar - dimcar -12
	...
	foglio.rectangle(z-5, qdest+(dimcar/2), w, -65).stroke
	foglio.save_state
	foglio.fill_color Color::RGB::White
	foglio.stroke_color Color::RGB::White
	foglio.rectangle(z, qdest, 92, 10).fill
	foglio.restore_state
	foglio.add_text(z, qdest, testodest, dimcar)

	testotrasp = "<b>D) TRASPORTO</b>"
	qtrasp = qvar - dimcar -12
	...
	foglio.rectangle(z-5, qtrasp+(dimcar/2), w, -106).stroke
	foglio.save_state
	foglio.fill_color Color::RGB::White
	foglio.stroke_color Color::RGB::White
	foglio.rectangle(z, qtrasp, 80, 10).fill
	foglio.restore_state
	...
	testosan2 = "Attesta (*) che dagli atti di questo ufficio, l'azienda di provenienza \xe8 sotto controllo ufficiale con la seguente qualifica"
	qvar = qvar -dimcar*1.9
	foglio.add_text(z, qvar, testosan2, dimcar)
	testosan3 = "sanitaria e che gli animali sopraindicati sono stati sottoposti con esito negativo alle prove diagnostiche per:"
	qvar = qvar -dimcar*1.9
	...
	foglio.rectangle(z-5, qsan+(dimcar/2), w, -205).stroke
	foglio.save_state
	foglio.fill_color Color::RGB::White
	foglio.stroke_color Color::RGB::White
	foglio.rectangle(z, qsan, 145, 10).fill
	foglio.restore_state
