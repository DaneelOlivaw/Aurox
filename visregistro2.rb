...
def visregistro2(selreg, datainizio, datafine, orientamento)
...
#	regricercaentry = Gtk::Entry.new
	...
	listareg = Gtk::ListStore.new(Integer, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String)
	vistareg = Gtk::TreeView.new(listareg)
	#puts vistareg.headers_clickable?
	vistareg.headers_clickable = true
	#puts vistareg.headers_clickable?
	vistareg.headers_visible = true
...
#	}
		...
		vistareg.append_column(colonna19)
...
#	boxreg1.pack_start(regricercaentry, false, false, 0)
	...
	listareg.signal_connect("sort_column_changed"){
		if listareg.sort_column_id[1].inspect.include?("ascending")
			ordine = disordine.sort_by { |hsh| hsh["nascitaepoch"] }
		elsif listareg.sort_column_id[1].inspect.include?("descending")
			ordine = disordine.sort_by { |hsh| hsh["nascitaepoch"] }.reverse!
		end
		#puts ordine.inspect
#		puts "ordine"
#		puts listareg.sort_column_id.inspect
#		puts listareg.sort_column_id[1].inspect
#		puts "ascendente" if 
	}
#	listareg.signal_connect("rows_reordered"){ #? #(path, iter, new_order)
#		puts "ordine"
#	}
